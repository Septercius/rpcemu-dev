...
static disc_funcs hfe_disc_funcs = { .seek = hfe_seek, .readsector = hfe_readsector, .writesector = hfe_writesector, .readaddress = hfe_readaddress, .poll = hfe_poll, .format = hfe_format, .stop = hfe_stop, .close = hfe_close };
