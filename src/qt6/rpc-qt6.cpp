 ...
 * data into the sound output buffer
 */
...
Emulator::Emulator()
{
    ...
    connect(this, &Emulator::key_press_signal, this, &Emulator::key_press);
 ...
 */
void Emulator::idle_process_events()
{
    const int32_t iomd_timer_interval = 2000000; // 2000000 ns = 2 ms (500 Hz)
 ...
 */
void Emulator::key_press(unsigned scan_code)
{
 ...
 * @param scan_code QT native host key code
 */
void Emulator::key_release(unsigned scan_code)
{
    const uint8_t *scan_codes = keyboard_map_key(scan_code);
 ...
 */
void Emulator::modifier_keys_changed(unsigned long mask)
{
 ...
 */
void Emulator::mouse_move(int x, int y)
{
 ...
 */
void Emulator::mouse_move_relative(int dx, int dy)
{
 ...
 */
void Emulator::mouse_press(int buttons)
{
 ...
 * @param buttons buttons pressed (QT format)
 */
void Emulator::mouse_release(int buttons)
{
 ...
 */
void Emulator::mouse_wheel(int dy)
{
 ...
 */
void Emulator::load_disc_0(QString discname)
{
    const char *p;
    QByteArray ba;
 ...
 * @param discname filename of disc image
 */
void Emulator::load_disc_1(QString discname)
{
    const char *p;
    QByteArray ba;
 ...
 */
void Emulator::cdrom_load_iso(QString discname)
{
    const char *p;
    QByteArray ba;
 ...
 */
void Emulator::cdrom_win_ioctl(char drive_letter)
{
    if (!config.cdromenabled)
    {
        config.cdromenabled = 1;
 ...
 */
void Emulator::config_updated(Config *new_config, Model new_model)
{
 ...
 * @param ipaddress
 */
void Emulator::network_config_updated(NetworkType network_type, QString bridgename, QString ipaddress)
{
 ...
 */
void Emulator::hostfs_updated(Config *new_config)
{
 ...
 */
void Emulator::show_fullscreen_message_off()
{
 ...
 * @param rule NAT rule details
 */
void Emulator::nat_rule_add(PortForwardRule rule)
{
 ...
 */
void Emulator::nat_rule_edit(PortForwardRule old_rule, PortForwardRule new_rule)
{
    // Activate the rule changes
 ...
 * @param rule NAT rule details
 */
void Emulator::nat_rule_remove(PortForwardRule rule)
{
    // Activate the rule changes
