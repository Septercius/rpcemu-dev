...
static int opANDreg(uint32_t opcode)
{
    uint32_t dest;
    ...
    {
        /* MUL */
        arm.reg[MULRD] = (MULRD == MULRM) ? 0 : (arm.reg[MULRM] * arm.reg[MULRS]);
    }
    else
    {
...
static int opANDregS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opEORreg(uint32_t opcode)
{
    uint32_t dest;
    ...
    {
        /* MLA */
        arm.reg[MULRD] = (MULRD == MULRM) ? 0 : (arm.reg[MULRM] * arm.reg[MULRS]) + arm.reg[MULRN];
    }
    else
    {
        dest = GETADDR(RN) ^ shift2(opcode);
...
static int opEORregS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opSUBreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opSUBregS(uint32_t opcode)
{
...
static int opRSBreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opRSBregS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opADDreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opADDregS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opADCreg(uint32_t opcode)
{
    uint32_t dest;
    ...
    if (arm.arch_v4 && (opcode & 0xf0) == 0x90)
    {
        ...
        uint64_t mula = (uint64_t) arm.reg[MULRS];
        uint64_t mulb = (uint64_t) arm.reg[MULRM];
        uint64_t current = ((uint64_t) arm.reg[MULRD] << 32) | arm.reg[MULRN];
...
static int opADCregS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opSBCreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opSBCregS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opRSCreg(uint32_t opcode)
{
    uint32_t dest;
    ...
    if (arm.arch_v4 && (opcode & 0xf0) == 0x90)
    {
        ...
        int64_t mula = (int64_t) (int32_t) arm.reg[MULRS];
        int64_t mulb = (int64_t) (int32_t) arm.reg[MULRM];
        int64_t current = ((int64_t) arm.reg[MULRD] << 32) | arm.reg[MULRN];
...
static int opRSCregS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opSWPword(uint32_t opcode)
{
...
static int opTSTreg(uint32_t opcode)
{
    uint32_t lhs;
...
static int opMSRcreg(uint32_t opcode)
{
...
static int opTEQreg(uint32_t opcode)
{
    uint32_t lhs;
...
static int opSWPbyte(uint32_t opcode)
{
    uint32_t addr, dest, data;
...
static int opCMPreg(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opMSRsreg(uint32_t opcode)
{
    if ((opcode & 0xf010) == 0xf000)
    {
        /* MSR SPSR,reg */
...
static int opCMNreg(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opORRreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opORRregS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opMOVreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opMOVregS(uint32_t opcode)
{
    if (RD == 15)
    {
...
static int opBICreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opBICregS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opMVNreg(uint32_t opcode)
{
    uint32_t dest;
...
static int opMVNregS(uint32_t opcode)
{
    if (RD == 15)
    {
        arm_write_r15(opcode, ~shift2(opcode));
...
static int opANDimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opANDimmS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opEORimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opEORimmS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opSUBimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opSUBimmS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opRSBimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opRSBimmS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opADDimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opADDimmS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opADCimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opADCimmS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opSBCimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opSBCimmS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opRSCimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opRSCimmS(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opTSTimm(uint32_t opcode)
{
    uint32_t lhs;
...
static int opMSRcimm(uint32_t opcode)
{
    if (RD == 15)
    {
        /* MSR CPSR,imm */
...
static int opTEQimm(uint32_t opcode)
{
    uint32_t lhs;
...
static int opCMPimm(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opMSRsimm(uint32_t opcode)
{
    if (RD == 15)
    {
        /* MSR SPSR,imm */
...
static int opCMNimm(uint32_t opcode)
{
    uint32_t lhs, rhs, dest;
...
static int opORRimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opORRimmS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opMOVimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opMOVimmS(uint32_t opcode)
{
    if (RD == 15)
    {
...
static int opBICimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opBICimmS(uint32_t opcode)
{
    uint32_t lhs, dest;
...
static int opMVNimm(uint32_t opcode)
{
    uint32_t dest;
...
static int opMVNimmS(uint32_t opcode)
{
    if (RD == 15)
    {
        arm_write_r15(opcode, ~arm_imm(opcode));
...
static int opB(uint32_t opcode)
{
    uint32_t offset;
    ...
    arm.reg[15] = ((arm.reg[15] + offset + 4) & arm.r15_mask) | (arm.reg[15] & ~arm.r15_mask);
    blockend = 1;
    return 0;
}

static int opBL(uint32_t opcode)
{
    uint32_t offset;
...
static int opcopro(uint32_t opcode)
{
#ifdef FPA
...
static int opMCR(uint32_t opcode)
{
#ifdef FPA
...
static int opMRC(uint32_t opcode)
{
#ifdef FPA
    if ((opcode & 0xf00) == 0x100)
    {
    ...
    if ((opcode & 0xf10) == 0xf10 && ARM_MODE_PRIV(arm.mode))
    {
        if (RD == 15)
        {
            arm.reg[RD] = (arm.reg[RD] & arm.r15_mask) | (cp15_read(opcode) & ~arm.r15_mask);
        }
        else
        {
 ...
 */
static int opUNALLOC(uint32_t opcode)
{
    NOT_USED(opcode);
...
static int opLDRH(uint32_t opcode)
{
    arm_ldrh(opcode);
    return (arm.event & 0x40);
}

static int opLDRSB(uint32_t opcode)
{
    arm_ldrsb(opcode);
    return (arm.event & 0x40);
}

static int opLDRSH(uint32_t opcode)
{
    arm_ldrsh(opcode);
    return (arm.event & 0x40);
}

static int opSTRH(uint32_t opcode)
{
    arm_strh(opcode);
    return (arm.event & 0x40);
}
