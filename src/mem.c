 ...
 */
void mem_reset(uint32_t ramsize, uint32_t vram_size)
{
...
static inline void vradd(uint32_t a, const void *v, uint32_t f, uint32_t p)
{
    NOT_USED(f);
...
static inline void vwadd(uint32_t a, const void *v, uint32_t f, uint32_t p)
{
    NOT_USED(f);
 ...
 */
uint32_t mem_phys_read32(uint32_t addr)
{
    addr &= phys_space_mask;

    switch (addr & (phys_space_mask & 0xff000000))
    {                    /* Select in 16MB chunks */
        case 0x00000000: /* ROM */
 ...
 */
static uint32_t mem_phys_read8(uint32_t addr)
{
    addr &= phys_space_mask;
 ...
 */
static void mem_phys_write32(uint32_t addr, uint32_t val)
{
    addr &= phys_space_mask;
 ...
 */
static void mem_phys_write8(uint32_t addr, uint8_t val)
{
    addr &= phys_space_mask;
