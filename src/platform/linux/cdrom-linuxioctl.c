...
static ATAPI ioctl_atapi = { ioctl_ready, ioctl_readtoc, ioctl_getcurrentsubchannel, ioctl_readsector, ioctl_playaudio, ioctl_seek, ioctl_null, ioctl_null, ioctl_null, ioctl_null, ioctl_null, ioctl_exit };
