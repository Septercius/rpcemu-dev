...
static ATAPI iso_atapi = { iso_ready, iso_readtoc, iso_getcurrentsubchannel, iso_readsector, iso_playaudio, iso_seek, iso_null, iso_null, iso_null, iso_null, iso_null, iso_exit };
