...
#define ARCEM_SWI_MULTI_HOSTFS_START (ARCEM_SWI_CHUNK + 0x10)
...
#define ARCEM_SWI_MULTI_HOSTFS_END (ARCEM_SWI_CHUNK + 0x15)
...
extern void multi_hostfs_swi(ARMul_State *state);
