...
static void cp15_tlb_flush(void)
{
    int c;
...
static void cp15_vaddr_reset(void)
{
    int c;
 ...
 */
void cp15_tlb_invalidate_physical(uint32_t addr)
{
    int c;
...
static void cp15_tlb_flush_all(void)
{
    clearmemcache();
    cp15_tlb_flush();
    cp15_vaddr_reset();
...
static void cp15_tlb_add_entry(uint32_t vaddr, uint32_t paddr)
{
 ...
 */
void cp15_write(uint32_t opcode, uint32_t val)
{
 ...
 */
uint32_t cp15_read(uint32_t opcode)
{
    const uint32_t crn = RN;
 ...
 */
static uint32_t cp15_domain_access(uint32_t domain)
{
...
const uint32_t *getpccache(uint32_t addr)
{
    uint32_t phys_addr;
